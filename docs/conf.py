# -*- coding: utf-8 -*-
#
# trump-net documentation build configuration file, created by
...
file_text = read(fpath('../trump_net/__meta__.py'))
...
htmlhelp_basename = 'trump-netdoc'
...
latex_documents = [
    ('index', 'trump-net.tex', u'trump-net Documentation',
...
man_pages = [
    ('index', 'trump-net', u'trump-net Documentation',
...
texinfo_documents = [
    ('index', 'trump-net', u'trump-net Documentation',
        u'Ian Dennis Miller', 'trump-net', 'One line description of project.',
        'Miscellaneous'),
]
